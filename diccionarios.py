...
def comprar():
        ...
        try:
            while True:
                num = int(input("Que producto desea comprar?: "))
                if num in productosDicc:
                        cant = int(input("Cual es la cantidad que desea comprar?: "))
                        carrito.append({
                            "nombre": productosDicc[num]["nombre"],
                            "precio": productosDicc[num]["precio"],
                            "cantidad": cant
                        })
                        print("="*30)
...
def crearBoleta():
    ...
    for item in carrito:
        ...
        total += subtotal
        print(f"{item['cantidad']}x {item['nombre']} - Subtotal: ${subtotal}")
    print("-"*30)
    print(f"total: ${round(total*1.19)}")
    print("="*30)
